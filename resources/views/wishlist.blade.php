					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/cart/iPhone 11.png" alt=""></a>
							</td>
							...
							<td class="cart_total">
								<p class="cart_total_price">Rp 6.999.000</p>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/cart/Xiaomi 13 13Pro.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Xiaomi 13 Pro</a></h4>
								<p>Phone ID: MI013P</p>
							</td>
							<td class="cart_price">
								<p>Rp 4.599.000</p>
							...
							<td class="cart_total">
								<p class="cart_total_price">Rp 4.599.000</p>
							</td>
							<td class="cart_delete">
								<a class="cart_quantity_delete" href=""><i class="fa fa-times"></i></a>
							</td>
