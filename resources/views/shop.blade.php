                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <img title=" " alt="{{ $d->NAMA_HP }}" width="250"
                                                height="200" src="{{ asset('images/shop/' . $d->image_hp) }}" />
                                            <h2>Rp {{ $d->HARGA_PEMBELIAN }}</h2>
                                            <p>{{ $d->NAMA_HP }}</p>
                                            <p>Ready Color : {{ $d->WARNA_HP }}</p>
                                            <p>Available Stock : {{ $d->STOCK_HP }}</p>
                                            @if (session()->has('userAccess'))                                                
