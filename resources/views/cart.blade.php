					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="images/cart/Samsung S23 Ultra.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Samsung Galaxy S23 Ultra</a></h4>
								<p>Phone ID: SS023P</p>
							</td>
							<td class="cart_price">
								<p>Rp 19.999.000</p>
							...
							<td class="cart_total">
								<p class="cart_total_price">Rp 19.999.000</p>
							</td>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Cart Sub Total <span>Rp19.999.000</span></li>
							{{-- <li>Eco Tax <span>Rp 0</span></li> --}}
							<li>Shipping Cost <span>Free</span></li>
							<li>Total <span>Rp19.999.000</span></li>
						</ul>
							<a class="btn btn-default update" href="">Update</a>
							<a class="btn btn-default check_out" href="/checkout">Confirm to Checkout</a>
					</div>
				</div>
			</div>
		</div>
