...
<body>
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="adminaccount" class="active"><i class="fa fa-user"></i> Account</a></li>																								
    ...
    <div class="wrapper">
        <div class="left">
            <img src="images/404268.jpg" alt="user" width="100">
            <h4>Angellie Ennovaryn Mertadana</h4>
        </div>
        <div class="right">
            <div class="info">
                <h3>Information</h3>
          ...
          <div class="projects">
                ...
                <div class="projects_data">
                     <div class="data">
                        <h4>Address</h4>
                        <p>Jl. Nangka No. 12, Banyuwangi</p>
                     </div>
                     <div class="data">
                       <h4>Birth Date</h4>
                        <p>2 April 1995</p>
