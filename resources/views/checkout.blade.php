	...
	<section id="cart_items">
		<div class="container">
						...
						<tr>
							...
							<td colspan="2">
								<table class="table table-condensed total-result">
									...
									<tr>
										<td>Total</td>
										<td><span>Rp 19.999.000</span></td>
									</tr>
								</table>
								<br><br>
								<div class="payment-options">
									<span>
										<a class="btn btn-default check_out" href="/payment">Confirm Purchase</a>
									</span>
								</div>
							</td>
						</tr>
			...
			<!-- <div class="payment-options">
				...
				<span>
					<a class="btn btn-default check_out" href="">Confirm Purchase</a>
				</span>
			</div> -->
		</div>
	</section> <!--/#cart_items-->
